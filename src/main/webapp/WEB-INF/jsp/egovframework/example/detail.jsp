    ...
    <body>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
            	<form name="detailFrm" method="POST" enctype="multipart/form-data" action="" >
	                    ...
	                    <div class="col-md-6">
	                        ...
	                        <div class="fs-5 mb-5">
	                            ...
	                            <span>$40.00</span>
	                       		 ...
	                       		 업체 및 서비스 소개 요약 <br>
	                        -->
	                        <p class="lead">${boardVO.summary }</p>
	                        <div class="d-flex">
	                        	<!-- 
                        		...
                        		<button class="btn btn-outline-dark flex-shrink-0" type="button" onclick="javascript:location.href='/ojt/update.do?b_idx=${boardVO.b_idx}'">
	                             	수정
	                            </button>
	                        </div>
	                        <!-- 판매서비스  내용 
