            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="detail.jsp">Details</a></li>
                    ...
                    <form class="d-flex">
                        ...
                        <button class="btn btn-outline-dark" type="submit">로그인
                        <!--  
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
	                ...
	                <c:forEach var="result" items="${boardVO}" varStatus="status">	
	                	<div class="col mb-5">
                ...
                <!--  
                    <div class="col mb-5">
                        <div class="card h-100">
                            <img class="card-img-top" src="./images/test.jpeg" style="width:100%;height:48%;" />
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <h5 class="fw-bolder">디자인해드립니다.</h5>
                                    	장인이 디자인해드립니다..
                                </div>
                            </div>
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
