...
<html lang="en">
    ...
    <body>
        ...
        <form name="updateFrm" method="POST" enctype="multipart/form-data" action="/ojt/updateAction.do"  >
	        <section class="py-5">
		                ...
		                <div class="row gx-4 gx-lg-5 align-items-center">
		                    ...
		                    <div class="col-md-6">
		                        <div class="small mb-1">
		                        	...
		                        	업체명<br>
									<input type="text" style="width:80%" name="userid" value="${boardVO.userid }"><br>
									서비스명<br>
									<input type="text" style="width:80%" name="title" value="${boardVO.title }"/><br>
		                       		업체 및 서비스 소개 요약<br>
		                        	<textarea style="width:80%;height:100px;" name="summary" >${boardVO.summary }</textarea><br>
