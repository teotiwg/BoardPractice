                            	...
                            	<c:forEach items="${likes}" var="like" varStatus="status">
						            	<div class="col-xl-2 col-md-6" style="margin:20px auto;">
							            	<div class="card bg text-black mb-3">
							                	<div>
								                	<a class="as" href="/ojt/detail.do?b_idx=${like.b_idx }"><img class="img" src="./images/${like.img }" style="width:100%;"></a>
							                    </div>
							                    ...
							                    <div style="margin:0 auto;font-size:10pt;">
					                            	<span class="view">
					                            		...
					                            		<fmt:formatNumber type="number" maxFractionDigits="3" value="${like.viewcount }" />
					                            	</span>
					                            	<%-- c:choose>
						                            ...
						                            <span class="likes">	
						                            	<i class="material-icons" style="font-size:12pt;">&#xe87e;</i>
						                            	<fmt:formatNumber type="number" maxFractionDigits="3" value="${like.likescount }" />	                            
						                            </span>
					                            </div>
							                </div>
							            </div>		
